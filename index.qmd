...
<a class="btn btn-outline" href="https://github.com/gates-dost-asti/A2A-MCPv2">View on GitHub</a>
</div>
</div>
...
<p>The hotspot and service-area workflow doesn't just answer questions. The same
underlying data drives the maps and charts below, generated straight from
<code>analytics/tables/</code>.</p>

<div class="gallery">
<figure>
<img src="analytics/maps/map_09_classification.png" alt="Province-level OneLab hotspot classification map">
<figcaption>Province hotspot classification</figcaption>
</figure>
<figure>
<img src="analytics/maps/map_01_agency_count.png" alt="OneLab agency count by province map">
<figcaption>Agency count by province</figcaption>
</figure>
<figure>
<img src="analytics/charts/chart_01_top_agencies.png" alt="Top 10 provinces by OneLab agency count bar chart">
<figcaption>Top 10 provinces by agency count</figcaption>
</figure>
<figure>
<img src="analytics/charts/chart_04_service_area_population.png" alt="Population by service area band bar chart">
<figcaption>Population by service-area band</figcaption>
</figure>
</div>
:::
...
├── analytics/
│   ├── tables/                # Hotspot &amp; service-area analysis outputs
│   ├── charts/                 # Sample analysis charts
│   └── maps/                   # Sample analysis maps
